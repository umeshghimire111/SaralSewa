...
<head>
  <meta charset="UTF-8">
  <title>SaralSewa Login OTP Code</title>
  <style>
    ...
    .otp-box { background: #eff6ff; border: 2px dashed #3b82f6; border-radius: 8px; padding: 20px; text-align: center; margin: 25px 0; }
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Here is your 6-digit One-Time Password (OTP) for logging in to your SaralSewa account:</p>
